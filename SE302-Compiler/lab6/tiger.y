...
%type <field> tyfields_nonempty_s
%type <ty> ty
...
lvalue:
	...
	;
one:
	ID %prec LOW {$$ = A_SimpleVar(EM_tokPos, S_Symbol($1));}
...
tyfields:
	...
	;
tyfields_nonempty:
	tyfields_nonempty_s {$$ = A_FieldList($1, NULL);}
	|tyfields_nonempty_s COMMA tyfields_nonempty {$$ = A_FieldList($1, $3);}
	;
tyfields_nonempty_s:
...
ty:
	...
	;
fundec:
	fundec_one %prec LOW {$$ = A_FundecList($1, NULL);}
